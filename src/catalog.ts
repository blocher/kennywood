...
export const ATTRACTION_CATALOG: Record<number, CatalogEntry> = {
  ...
  900001: { id: 900001, name: "Auto Race", rideType: "kiddie ride", envelopeMinIn: null, envelopeMaxIn: null, themeParksId: "adb65ee3-c608-474f-ac58-98d4434ecea8", notes: "No QT wait; under 46″ companion; infants not permitted; Attraction page Family Ride → product Kids" },
  ...
  900011: { id: 900011, name: "Kenny's Cargo Drop", rideType: "kiddie ride", envelopeMinIn: 42, envelopeMaxIn: null, themeParksId: "506832a1-1746-4c6f-892a-388229ebe3cd", notes: "No QT wait; Attraction Family Ride / Accessibility Children’s Rides → product Kids" },
  900012: { id: 900012, name: "Coal Haulin’ Convoy", rideType: "kiddie ride", envelopeMinIn: null, envelopeMaxIn: null, themeParksId: "cb9cb785-2b48-4f52-8a8e-80ddcabfec39", notes: "No QT wait; under 36″ companion; Attraction page Family Ride → product Kids" },
  ...
  900015: { id: 900015, name: "Fire Bustin’ Brigade", rideType: "kiddie ride", envelopeMinIn: null, envelopeMaxIn: null, themeParksId: "885bd94b-e9a2-435b-8efc-fd8ef507ab57", notes: "No QT wait; under 36″ companion; Attraction page Family Ride → product Kids; Temporarily Unavailable" },
  ...
  900017: { id: 900017, name: "Lil’ Phantom", rideType: "kiddie ride", envelopeMinIn: null, envelopeMaxIn: null, themeParksId: "ad7474ed-ddef-4522-a21e-4f8135f5dedb", notes: "No QT wait; Kiddieland (Attraction page says Roller Coaster); under 36″ companion" },
  900018: { id: 900018, name: "Parker's Cloud Cruisers", rideType: "kiddie ride", envelopeMinIn: null, envelopeMaxIn: null, themeParksId: "b45e74b8-29d5-4c86-a764-cbd8bdee301f", notes: "No QT wait; under 36″ companion; Attraction page Family Ride → product Kids" },
